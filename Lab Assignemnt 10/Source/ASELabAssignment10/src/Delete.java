...
public class Delete extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		MongoClientURI uri = new MongoClientURI("mongodb://abc123:abc123@ds031995.mlab.com:31995/gshkr_asedb");
        ...
        out.println("</form></div></div><h4 style='color:white'>Users List</h4><center><div class='table-responsive' style='width:50%'><table class='table' style='color:black;border:1px solid black'>");
